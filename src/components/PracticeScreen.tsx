  ...
  return (
    <div className="relative min-h-screen">
      ...
      <header className="fixed top-0 w-full z-50 flex items-center justify-between px-6 md:px-16 h-16 bg-[#0f131f]/60 backdrop-blur-xl border-b border-white/10 shadow-[0_0_20px_rgba(0,210,255,0.05)]">
        ...
        <div className="font-sans font-bold text-sm text-slate-400 font-mono flex items-center gap-1">
          <span className="hidden sm:inline">Topic:</span>
          <span className="text-[#00FBFF] max-w-[120px] sm:max-w-none truncate inline-block align-bottom">{topicToLoad}</span>
        </div>
      </header>
