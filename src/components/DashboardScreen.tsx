      ...
      <header className="fixed top-0 w-full z-50 flex items-center justify-between px-6 md:px-16 h-16 bg-[#0f131f]/60 backdrop-blur-xl border-b border-white/10 shadow-[0_0_20px_rgba(0,210,255,0.05)]">
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="text-xs transition-colors py-1.5 px-3 rounded-lg border border-slate-800 hover:border-cyan-500 bg-[#0a0e1a]/40 font-mono text-slate-300 hover:text-cyan-400 cursor-pointer flex items-center gap-2 focus:outline-none"
          >
            <span>{userState.email || "Guest Node"}</span>
          </button>
        </div>
      </header>
